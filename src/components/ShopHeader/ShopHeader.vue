<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" @click="isActivityShow = true" v-if="info.supports">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="isShopShow">
        ...
        <div class="brief-modal-cover" @click="isShopShow = false"></div>
      </div>
    </transition>
    ...
    <transition name="move">
      <div class="activity-sheet" v-show="isActivityShow">
        ...
        <div class="activity-sheet-cover"  @click="isActivityShow = false"></div>
      </div>
    </transition>
  </div>
</template>
